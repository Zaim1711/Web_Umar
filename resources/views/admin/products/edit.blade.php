                    ...
                    <div class="card-body">
                        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                               ...
                               <textarea class="form-control @error('type') is-invalid @enderror" name="type" rows="5" placeholder="Masukkan Type Mobil">{{ old('type',$product->type) }}</textarea>
                                <!-- error message untuk title -->
                                @error('type')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('harga') is-invalid @enderror" name="harga" rows="5" placeholder="Masukkan Harga Mobil">{{ old('harga',$product->harga) }}</textarea>
                                <!-- error message untuk title -->
                                @error('harga')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class= "form-control @error ('video_link') is-invalid @enderror" name="video_link" placeholder ="Masukan Link Video">{{ old('video_link', $product->video_link)}}</textarea>
                                
                                <!-- error message untuk video_link -->
                                @error('video_link')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
