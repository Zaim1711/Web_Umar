                    ...
                    <div class="card-body">
                        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                               ...
                               <textarea class="form-control @error('type') is-invalid @enderror" name="type" rows="5" placeholder="Masukkan Type Mobil">{{ old('type') }}</textarea>
                                <!-- error message untuk title -->
                                @error('type')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('harga') is-invalid @enderror" name="harga" rows="5" placeholder="Masukkan Harga Mobil">{{ old('harga') }}</textarea>
                                <!-- error message untuk title -->
                                @error('harga')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" name="video_link" class="form-control" id="video_link" placeholder="Enter YouTube video link">
                            </div>
                            <div class="form-group mb-3">
